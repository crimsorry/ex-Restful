...
import egovframework.rte.rex.cgr.service.CategoryVOList;
...
public class EgovCategoryController {
	...
	public String update(@Valid CategoryVO updateCategory, BindingResult results,
		...
		List<CategoryVO> categoryLists = categoryService.selectCategoryList();
		CategoryVOList categoryVOList = new CategoryVOList();
		categoryVOList.setItems(categoryLists);
		model.addAttribute("root", categoryVOList);
